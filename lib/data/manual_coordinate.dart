// file: lib/data/manual_coordinates.dart
...
class ManualCoordinates {
  static final Map<String, LatLng> coordinates = {
    ...
    'id-8': LatLng(-8.675550, 115.261086),
    'Gateway 2': LatLng(-8.675835, 115.260998),
    'id-9': LatLng(-8.676123, 115.260995),
    ...
    // 'id-17': LatLng(-8.678056, 115.259722),
    'id-15': LatLng(-8.676389, 115.261944),
    'id-16': LatLng(-8.676902, 115.261730),
    'id-17': LatLng(-8.678793, 115.261249),
  };
}
